            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
              ...
              <div className="flex gap-1.5 ml-auto overflow-x-auto scrollbar-none">
                <button onClick={toggleWatchlist}
                  className={clsx('flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-mono border transition-all flex-shrink-0',
                  ...
                  <Star className={clsx('w-3 h-3', inWatchlist && 'fill-accent-yellow')} />
                  <span className="hidden sm:inline">{inWatchlist ? 'Guardado' : 'Watchlist'}</span>
                </button>
